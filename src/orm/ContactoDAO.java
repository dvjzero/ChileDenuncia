...
public class ContactoDAO {
	public static Contacto loadContactoByORMID(int con_id) throws PersistentException {
		try {
			PersistentSession session = orm.ChileDenunciaPersistentManager.instance().getSession();
			return loadContactoByORMID(session, con_id);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Contacto getContactoByORMID(int con_id) throws PersistentException {
		try {
			PersistentSession session = orm.ChileDenunciaPersistentManager.instance().getSession();
			return getContactoByORMID(session, con_id);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(int con_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.ChileDenunciaPersistentManager.instance().getSession();
			return loadContactoByORMID(session, con_id, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(int con_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.ChileDenunciaPersistentManager.instance().getSession();
			return getContactoByORMID(session, con_id, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(PersistentSession session, int con_id) throws PersistentException {
		try {
			return (Contacto) session.load(orm.Contacto.class, new Integer(con_id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(PersistentSession session, int con_id) throws PersistentException {
		try {
			return (Contacto) session.get(orm.Contacto.class, new Integer(con_id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(PersistentSession session, int con_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Contacto) session.load(orm.Contacto.class, new Integer(con_id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(PersistentSession session, int con_id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Contacto) session.get(orm.Contacto.class, new Integer(con_id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ChileDenunciaPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ChileDenunciaPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ChileDenunciaPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ChileDenunciaPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
