...
public class ChileDenunciaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ChileDenuncia";
	...
	private ChileDenunciaPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm.Usuario.class);
		configuration.addAnnotatedClass(orm.Denuncia.class);
		configuration.addAnnotatedClass(orm.Estadistica_denuncias.class);
		configuration.addAnnotatedClass(orm.Estado_denuncia.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ChileDenunciaPersistentManager();
		}
